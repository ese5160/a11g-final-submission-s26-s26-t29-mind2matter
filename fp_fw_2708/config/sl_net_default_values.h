...
#ifndef DEFAULT_WIFI_CLIENT_BAND
#define DEFAULT_WIFI_CLIENT_BAND SL_WIFI_AUTO_BAND
#endif

#ifndef DEFAULT_WIFI_CLIENT_CHANNEL
#define DEFAULT_WIFI_CLIENT_CHANNEL SL_WIFI_AUTO_CHANNEL
#endif
...
#define DEFAULT_WIFI_CLIENT_PROFILE \
  ...
  {                                 \
    .config = { \
        ...
        .channel.channel = DEFAULT_WIFI_CLIENT_CHANNEL, \
        .channel.band = DEFAULT_WIFI_CLIENT_BAND, \
